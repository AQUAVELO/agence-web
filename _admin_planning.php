<?php
/**
 * Interface d'administration discrète pour le planning - Version Corrigée
 */
...
// 2. LOGIQUE D'ADMINISTRATION (Traitement avant affichage)
if ($authenticated && isset($_GET['action'])) {
    ...
    // Redirection en JS pour éviter le problème de headers
            ...
            <div>
              ...
              ?>
                <div style="margin-bottom: 8px; padding: 8px; border-radius: 5px; background: <?= $is_taken ? '#fff3cd' : 'white' ?>; border: 1px solid <?= $is_taken ? '#ffeeba' : '#eee' ?>; font-size: 0.85rem;">
                  ...
                  <?php if ($is_taken) : ?>
                    <div style="color: #856404; margin-bottom: 8px; font-weight: bold;">👤 <?= $existing_bookings[$key]['name'] ?></div>
