...
<section class="content-area bg1">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <iframe width=580" height="360" src="https://www.youtube.com/embed/0e-ztRbqNhA?list=PLPohPdVnIO0YaRRepsFSE-9qhxHF3Fxwh&amp;ecver=1" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
      ...
      <div class="col-md-6">
        ...
        <p>
          L'aquavélo ou vélo dans l'eau est une nouvelle discipline de fitness intelligente pour brûler des calories et perdre du poids, chasser la cellulite et éliminer les toxines et par la même occasion tonifier son corps.</p>

        <p>
          L’aquavélo est un sport mixte; même si on trouvera sans doute une majorité de femmes dans le bassin : tout simplement parce qu’elles sont les seules à souffrir de la cellulite, et que  l’aquavélo est un ennemi redoutable de la peau d’orange. Le pédalage aquatique favorise progressivement la destruction de la cellulite en produisant un massage continu sur les jambes, le bassin et la ceinture abdominale.</p>
<p>Pratiqué régulièrement, il permet de prévenir et d’éviter la rétention d’eau et les oedèmes.
Ces messieurs ne seront pas en reste! La résistance de l’eau agit sur toute la musculature en garantissant la tonification et le remodelage du corps. Les bras sont également sollicités pour faire travailler les biceps et triceps.
...
<p>Pratique pour les jeunes mamans qui n’ont que peu de temps à se consacrer après l’accouchement.</p>
      ...
      <div class="col-md-6 col-sm-6">
        ...
        <div class="progress">
          ...
          <div class="progress-bar" role="progressbar" aria-valuenow="70" data-percentage="70" aria-valuemin="0" aria-valuemax="100">
          </div>
        </div>
        <div class="progress">
          ...
          <div class="progress-bar" role="progressbar" aria-valuenow="50" data-percentage="50" aria-valuemin="0" aria-valuemax="100">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="flexslider std-slider center-controls" data-animation="fade" data-loop="true" data-animspeed="600" data-dircontrols="true" data-controls="true">
      <ul class="slides">
        ...
        <li>
          <blockquote class="huge text-center">
            <p>
              Ne vous forcez plus à aller dans une salle de sport, il y a l'Aquavelo, et j'y vais tous les jours !</p>
        ...
        <div class="buttonBox table-content">
          <div class="table-row">
            <div class="table-cell">
              <p>
                Vous aussi, vous voulez essayer ?
              </p>
            </div>
