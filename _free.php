...
<section class="content-area bg1">
  <div class="container">
    <div class="row">
      <div class="col-md-6"> <img src="/imageprocessor.php?src=http://aquavelo.com/images/center_179/1.jpg&w=800" alt=" ">
        <div class="row" style="margin-top:30px;">
          <div class="col-md-6"> <img src="/imageprocessor.php?src=http://aquavelo.com/images/center_179/2.jpg&w=800" alt=" "> </div>
          <div class="col-md-6"> <img src="/imageprocessor.php?src=http://aquavelo.com/images/center_179/3.jpg&w=800" alt=" "> </div>
...
?>
            <option <? if(isset($_GET['city']) &&  $_GET['city'] == $free_d['city']) echo 'selected';?> value="<?=$free_d['id']?>"><?=$free_d['city']?></option>
            <? } ?>
            </select>
          </div>
          <div class="form-group">
