...
$title = "Inscription Client | Aquavelo";
?>
...
<style>
    .form-wrapper {
        ...
        align-items: center;
        min-height: 50vh; /* Hauteur minimale pour occuper l'espace entre nav et footer */
        padding: 20px 0;
    }
    .form-container {
        max-width: 600px;
        ...
        position: relative; /* Reset si position absolute était présente */
        float: none !important; /* Contre tout float:right */
    }
    h2 {
        text-align: center;
        color: #47c3e6;
