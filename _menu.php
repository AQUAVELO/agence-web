...
if ($userInfo) {
    ...
    if ($latestWeight > 0 && $taille > 0) {
        ...
        if ($imc < 20) {
            ...
            $message = "Félicitations, vous avez un IMC normal, continuez à vous entretenir, à manger crudités, légumes et fruits réguliérement. L'activité physique est bénéfique donc 30 minutes d'une activité cardio vasculaire comme l'Aquavélo vous permettra d'affiner et de raffermir votre silhouette.";
            ...
            $message = "Adopter une alimentation équilibrée et hypocalorique : Consommez plus de fruits, légumes, grains entiers, et protéines maigres. Limitez les aliments riches en graisses saturées, sucres ajoutés, et sel. Évitez les boissons sucrées et les fast-foods.
...
Planification des repas : Planifiez vos repas à l'avance pour éviter les choix alimentaires impulsifs. Préparez des collations saines pour éviter les fringales.
Exercice régulier :Faites au moins 150 minutes d'activité physique modérée par semaine (comme la marche rapide, l‘Aquavélo, ou le cyclisme).
Incorporez des exercices de renforcement musculaire au moins deux jours par semaine. Intégrer plus d'activité dans la routine quotidienne . Hydratation : Buvez au moins 1,5 à 2 litres d'eau par jour. Évitez les boissons sucrées et alcoolisées.
Gestion du stress :Pratiquez des techniques de relaxation comme la méditation, le yoga ou la respiration profonde. Assurez-vous de dormir suffisamment (7 à 9 heures par nuit).
Suivi et soutien :Tenez un journal alimentaire pour suivre ce que vous mangez.";
        }
