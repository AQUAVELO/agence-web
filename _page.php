  ...
  <div class="container">
    <div class="row">
	  ...
	  <dd>
          ...
          <dd> <A href="#" onClick="window.open('/resultat.html','Résultats Minceurs','toolbar=0, location=0, directories=0, status=0, scrollbars=0, resizable=0, copyhistory=0, menuBar=0, width=700, height=700');return(false) class="btn btn-default"">Voir</A> </dd>
