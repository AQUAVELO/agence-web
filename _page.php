 ...
 <div id="imageCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
          <img src="/cloud/thumbnail/center_<?= $row_center['id']; ?>/1.jpg" alt="Image 1">
        </div>
        <div class="item">
          <img src="/cloud/thumbnail/center_<?= $row_center['id']; ?>/2.jpg" alt="Image 2">
        </div>
        <div class="item">
          <img src="/cloud/thumbnail/center_<?= $row_center['id']; ?>/3.jpg" alt="Image 3">
        </div>
      </div>
