    ...
    <div class="row">
      ...
      <div class="col-md-6">
         ...
         <dl style="margin-top:30px;">
          ...
          <dd> <A HREF="#" onClick="window.open('/siteinternetClaude/resultat.html','Résultats Minceurs','toolbar=0, location=0, directories=0, status=0, scrollbars=0, resizable=0, copyhistory=0, menuBar=0, width=700, height=700');return(false)">Cliquez Ici</A> </dd>
