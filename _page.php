...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <?php if (isset($row_center['id']) && in_array($row_center['id'], [305, 347, 349])) : ?>
      		<p>en vous inscrivant sur notre <span style="color: lightblue;"><strong>calendrier</strong> <a href="https://calendly.com/aqua-cannes/rdv-aquavelo" target="_blank">(cliquez ici)</a></span> ou en prenant rendez-vous ci-dessous.</p>
	    <?php endif; ?>
    ...
    <?php if ($row_center['id'] == 253 && !empty($row_center['book_link'])) { ?>
