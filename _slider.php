          ...
          <div class="inner">
            <div class="row">
              <div class="col-md-6 pull-left animated" data-fx="fadeIn" style="width: 100%; text-align: center; margin-top:0;">
				...
				<br><span style="color: #fff; font-size: 80%; text-shadow: 2px 2px 5px #000; text-transform: lowercase; font-weight: normal; font-size: 120%;">ou -10% sur votre formule</span>
