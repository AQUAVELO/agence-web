          ...
          <div class="inner">
            <div class="row">
              <div class="col-md-6 pull-left animated" data-fx="fadeIn" style="width: 100%; text-align: center; margin-top:0;">
				...
				<br />=1 abonnement <span style="font-size:50px; line-height: 60px !important; color: #1c4296; -webkit-text-stroke-color: #e54488; text-transform:uppercase;">offert</span> !</strong>
				<br /><br /><br /><p style="text-align:left; font-size:30px; line-height: 30px; color: #1c4296; -webkit-text-stroke-color: #fff;">Jusqu'à 10 séances<br />en plus sur votre formule</p>
				</a>
				</h3>
