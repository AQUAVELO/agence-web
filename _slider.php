          ...
          <div class="inner">
            <div class="row">
              <div class="col-md-6 pull-left animated" data-fx="fadeIn" style="width: 100%; text-align: center; margin-top:0;">
                <h3 class="pa slidertext" style="float:left; text-align:center; text-transform: uppercase; color: #fff;text-shadow: -4px 4px 4px purple !important;"><a href="/seance-decouverte/Antibes"><span style="color:#000; font-size: 45px !important; line-height: 50px !important;">"</span>Une bonne <span style="color:f0b0fb;">santé</span>,
