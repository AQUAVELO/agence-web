...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['calculate_bmi'])) {
        ...
        if ($weight > 0 && $height > 0) {
            ...
            if ($imc < 20) {
                $bmi_message = "Vous êtes trop maigre.";
            } elseif ($imc > 25) {
                $bmi_message = "Vous êtes en surcharge pondérale.";
            } elseif ($imc >= 20 && $imc <= 25) {
                $bmi_message = "Félicitations, vous avez un IMC normal, continuez à vous entretenir.";
            }
        } else {
