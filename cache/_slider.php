  <section class="flexslider std-slider" data-height="560" data-loop="true" data-smooth="false" data-slideshow="true" data-speed="15000" data-animspeed="550" data-controls="true" data-dircontrols="true">
    ...
    <li data-bg="/images/content/home-v1-slider-01.jpg">
        <div class="container">
          <div class="inner">
            <div class="row">
              <div class="col-md-6 pull-left animated" data-fx="fadeIn" style="width: 100%; text-align: LEFT;">
                <h3 style="color: #e53517; text;font-size: 44px;Line-Height: 50pt" class="pa" >PORTES OUVERTES</h3>
				  <h3 style="color:#e53517" class="pa" ></h3>
                  <a href="/seance-decouverte/Antibes" id="sticker-text" style="background-image: url(/images/sticker1-blue.png); background-repeat: no-repeat; background-size: cover; display: inline-block;  padding: 4.5rem 5rem 2rem; text-decoration:none;">
                  <p style="style="font-weight: 300;">ESSAYEZ<br> UNE SÉANCE<br>GRATUITE<br>d'AQUAVELO</p>
				  </a> 
              </div>
              </div>
            </div>
