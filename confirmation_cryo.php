...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $macOk = isset($_POST['MAC']) && validateMAC($_POST, MONETICO_KEY);
    ...
    // Réponse pour CGI2 (indépendamment de l'affichage visuel pour l'utilisateur)
    header('Content-Type: text/plain');
    echo "version=2\ncdr=" . ($macOk ? "0" : "1") . "\n";
    exit;
}

// Redirection si appelé en GET (sécurité)
