...
if( isset($_POST['nom']) && empty($_POST['spam-check']) ) {
	...
	//PHPMAILER
	$mail->From='service.clients@aquavelo.com';
	$mail->FromName = 'Service clients Aquavelo';
	...
	<p>Bonjour '.$name.', </p><p>Nous avons bien re&ccedil;u votre demande pour une s&eacute;ance d&eacute;couverte gratuite.</p> <p>Le centre <strong>Aquavelo de '.$city.'</strong> est heureux de vous accueillir pour vous faire essayer un <strong>cours d\'aquabiking coaché</strong> par des professeurs de sport diplom&eacute;s &agrave; la suite d\'un <strong>bilan</strong> durant lequel nous d&eacute;finirons vos besoins et vos objectifs.</p>
	...
	<p>Cordialement,<br>L\'&eacute;quipe Aquavelo<br>http://aquavelo.com/</p>';
  	//PHPMAILER
	$mail2->From='service.clients@aquavelo.com';
	$mail2->FromName = 'Service clients Aquavelo';
