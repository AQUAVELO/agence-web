...
if(! defined('ERROR_IMAGE') )				define ('ERROR_IMAGE', 'http://aquavelo.com/images/center_179/1.jpg');								// Image to serve if an error occurs instead of showing error message 
