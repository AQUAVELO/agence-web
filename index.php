...
<head>
  ...
  <meta name="keywords" content="aquavelo, aquabiking, waterbike, aquabike, anti cellulite, amincissement, perte de poids, kg en moins, affinement rapide de la silhouette">
      ...
      <div class="container mainfooter">
        <div class="row">
          <aside class="col-md-3 widget"> <img src="/images/content/logo-footer.png" alt=" "> <br>
            <br>
            <h1 class="darker"; style="font-size: 12px>Aquabiking collectif en piscine</h1>
