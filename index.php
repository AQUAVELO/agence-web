      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li <?php if ($page == 'partenaires') echo ' class="active"'; ?> class="dropdown"> 
      ...
      <div class="container mainfooter">
        <div class="row">
          ...
          <aside class="col-md-3 widget">
            ...
            <p><strong>Tél:</strong> <a href="tel:0622647095">06 22 64 70 95</a></p>
          </aside>
          <aside class="col-md-3 widget">
            ...
            <ul>
              ...
              <li><a href="/franchise" style="color: #ff9800; font-weight: 600;">Ouvrir un Centre</a></li>
