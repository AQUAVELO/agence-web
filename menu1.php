...
<div class="container">
    ...
    <div class="highlight-box">
        ...
        <p>Depuis ce matin il y a eu <?php echo $imc_counter; ?> personnes avec un IMC supérieur à 25 qui ont bénéficié d'une séance gratuite + un cadeau supplémentaire.</p>
    </div>
