...
// Démarrer la session pour récupérer les données
session_start();

// Récupérer le message et le département depuis la session
...
if ($dept) {
    try {
        $stmt = $database->prepare("SELECT prenom, ville FROM client WHERE dept = :dept");
