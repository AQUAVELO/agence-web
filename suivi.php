    ...
    if (empty($date) || $poids <= 0) {
        ...
        try {
            ...
            if ($insert_stmt->execute([$email, $date, $poids, $trtaille, $trhanches, $trfesses])) {
                ...
                // Mettre à jour lastMensuration pour affichage
                $stmt_last->execute([$email]);
                $lastMensuration = $stmt_last->fetch(PDO::FETCH_ASSOC);
            } else {
...
<div class="suivi-container">
    ...
    <div class="user-badge">
        ...
        <br/>
        <small style="opacity: 0.9;"><?php echo htmlspecialchars($email); ?></small>
    </div>
    ...
    <div class="footer-note">
        ...
        <p style="margin-top: 10px;">
            <a href="_menu.php" style="color: #4caf50; text-decoration: none; font-weight: 600;">
                <i class="fa fa-bar-chart"></i> Voir mon historique complet
            </a>
        </p>
    </div>
